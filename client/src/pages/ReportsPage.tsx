        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-4xl font-black bg-gradient-to-r from-[#0066cc] to-[#0052a3] bg-clip-text text-transparent">Daily Work Reports</h1>
                <p className="text-muted-foreground mt-1">Track your daily tasks and progress</p>
              </div>
            </div>
          </div>
          <Button 
